...
class ExampleEmailModal extends React.Component {
	constructor(props){
		super();
						...
						<div className="modal-container example-modal">
							<div className="modal-content-wrapper">
								<div className="example-modal-content">
									<h3>Example Email Proposal</h3>
									<p>"Generating" a proposal will create a ready-to-send professional 3 page PDF.</p>
									<a href="/docs/se-email-example.html" target="_blank" className="button">View Email</a>
								</div>
								<div className="example-modal-image">
									<img src="images/example-hero-email.png" alt="Sponsor Proposal Example Email" />
								</div>
							</div>
...
export default connect(mapDispatchToProps)(ExampleEmailModal);
